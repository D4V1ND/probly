...
def multiclass_torch_model() -> nn.Module:
    """Return a small multiclass model."""
    return nn.Sequential(
        nn.Linear(10, 4),
    )
...
def setup(binary_torch_model: nn.Sequential, multiclass_torch_model: nn.Sequential) -> SetupReturnType:
    """Set up the models and dataloaders for testing."""
...
def test_fit_binary(setup: SetupReturnType) -> None:
    """Test if the fit method works correctly with binary models."""
...
def test_predict_binary(setup: SetupReturnType) -> None:
    """Test if the predict method works correctly with binary models."""
...
def test_fit_multiclass(setup: SetupReturnType) -> None:
    """Test if the fit method works correctly with multiclass models."""
...
def test_predict_multiclass(setup: SetupReturnType) -> None:
    """Test if the predict method works correctly with multiclass models."""
